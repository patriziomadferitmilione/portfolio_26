export const messages = {
  en: {
    ...
    admin: {
      ...
      audioUploadHelp: "Upload audio here. It fills track audio path automatically.",
      artworkUploadHelp: "Upload cover art here. It fills release artwork path automatically.",
      audioPathHelp: "Use uploaded audio path or a hosted file path. This points to track audio.",
      artworkPathHelp: "Use uploaded artwork path or a hosted file path. This points to release cover art.",
  ...
  it: {
    ...
    admin: {
      ...
      audioUploadHelp: "Carica qui l'audio. Compila automaticamente il percorso audio della traccia.",
      artworkUploadHelp: "Carica qui la cover. Compila automaticamente il percorso artwork della release.",
      audioPathHelp: "Usa il percorso audio caricato o un percorso file ospitato. Qui punta all'audio della traccia.",
      artworkPathHelp: "Usa il percorso artwork caricato o un percorso file ospitato. Qui punta alla cover della release.",
